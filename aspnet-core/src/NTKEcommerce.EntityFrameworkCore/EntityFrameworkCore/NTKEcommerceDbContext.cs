...
using NTKEcommerce.Inventories;
using NTKEcommerce.InventoryTickets;
using NTKEcommerce.Manufacturers;
using NTKEcommerce.Orders;
using NTKEcommerce.ProductAttributes;
using NTKEcommerce.ProductCategories;
using NTKEcommerce.Products;
using NTKEcommerce.Promotions;
...
public class NTKEcommerceDbContext :
    AbpDbContext<NTKEcommerceDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    public NTKEcommerceDbContext(DbContextOptions<NTKEcommerceDbContext> options)
        : base(options)
    {
